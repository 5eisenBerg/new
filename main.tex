...
\toprule
\textbf{Policy} & \textbf{Throughput (kbps)} & \textbf{PDR (\%)} & \textbf{PLR (\%)} & \textbf{Normal Delay (s)} & \textbf{HP Delay (s)} & \textbf{Energy (nJ/bit)} & \textbf{HP Delivery Ratio (\%)} \\
\midrule
